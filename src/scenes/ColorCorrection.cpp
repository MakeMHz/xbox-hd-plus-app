...
{
    ColorCorrection* scene = static_cast<ColorCorrection *>(obj->user_data);
...
ColorCorrection::ColorCorrection()
{
    ...
    lv_label_set_text(label1, "TODO ColorCorrection");
...
ColorCorrection::~ColorCorrection(void) {
    // TODO: Clean up all of the other objects.
    lv_obj_del(screen);
}

void ColorCorrection::OnObjectEvent(lv_obj_t* obj, lv_event_t event)
{
